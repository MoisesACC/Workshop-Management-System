    ...
    return (
        <div className="bg-background-dark font-display text-gray-100 antialiased overflow-x-hidden">
            ...
            <div className="w-full py-8 bg-white relative overflow-hidden group">
                ...
                <div className="flex animate-marquee gap-16 items-center w-max pb-4">
                    {/* Double the array for infinite effect */}
                    {[...brands, ...brands].map((brand, i) => (
                        <div key={i} className="flex-shrink-0 w-48 h-20 flex items-center justify-center transition-all duration-500 transform hover:scale-105">
                            <img
                                src={brand.logo}
                                alt={brand.name}
                ...
                <div className="flex animate-marquee-reverse gap-16 items-center w-max pt-4 border-t border-gray-100/50">
            ...
            <section className="py-20 bg-white relative overflow-hidden border-t border-gray-100">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex animate-marquee-reverse gap-20 items-center w-max pt-8 border-t border-gray-50">
