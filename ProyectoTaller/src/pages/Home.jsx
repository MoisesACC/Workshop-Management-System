...
const Home = () => {
    ...
    return (
        <div className="bg-background-dark font-display text-gray-100 antialiased overflow-x-hidden">
            ...
            {/* --- HERO SECTION --- */}
            <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-2 pb-20 lg:py-0">
                ...
                <div className="relative z-10 container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center pt-10 lg:pt-20">
